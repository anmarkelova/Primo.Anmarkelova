...
{
    public class CityPressure : PrimoComponentTO<Design.CityPressure_Form>
    {
        private const string GROUP_NAME = "CustomLib" + WFPublishedElementBase.TREE_SEPARATOR + "Погода OpenWeatherMap",
                             ...
                             ACTIVITY_NAME = "Давление в городе",
                             ACTIVITY_DESCRIPTION = "Активность позволяет получить текущий уровень давления в указанном городе.",
        ...
        /// <summary>
        /// Свойство, которое хранит давление в городе.
        /// </summary>
        [LTools.Common.Model.Serialization.StoringProperty]
        [System.ComponentModel.Category(OUTPUT_CATEGORY), System.ComponentModel.DisplayName("Давление")]
        public string Pressure
        {
            get { return this.pressure; }
            set { this.pressure = value; this.InvokePropertyChanged(this, nameof(Pressure)); }
        }
        #endregion


        #region [PROPERTIES][TYPES]
        public CityPressure(IWFContainer container) : base(container)
        {
            ...
            sdkComponentHelp += "\r\n"
                             + nameof(Pressure) + "*: Давление в городе.";
            ...
            sdkProperties = new List<LTools.Common.Helpers.WFHelper.PropertiesItem>()
            {
                ...
                new LTools.Common.Helpers.WFHelper.PropertiesItem()
                {
                    PropName = nameof(Pressure),
                    PropertyType = LTools.Common.Helpers.WFHelper.PropertiesItem.PropertyTypes.VARIABLE,
                    EditorType = ScriptEditorTypes.NONE,
                    DataType = typeof(string), ToolTip = "[string] Давление в городе по данным OpenWeatherMap", IsReadOnly = false
                },
            };
            InitClass(container);
        }
        ...
        public override ExecutionResult TimedAction(ScriptingData sd)
        {
            try
            {
                ...
                var response = new WeatherData().GetWeatherAttribute(key, chosenCity, WeatherAttribute.Pressure);
